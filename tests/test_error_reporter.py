...
class TestCompilationError:
    ...
    def test_error_creation(self):
        ...
        location = SourceLocation("test.game", 1, 5, 3)
    ...
    def test_error_string_representation(self):
        ...
        location = SourceLocation("test.game", 10, 15, 1)
        error = CompilationError(
        ...
        error_str = str(error)
        assert "test.game:10:15" in error_str
...
class TestErrorReporter:
    ...
    def test_reporter_initialization(self):
        ...
        source = "game MyGame {\n    title = \"Test\"\n}"
        reporter = ErrorReporter(source, "test.game")
        
        assert reporter.source_code == source
        assert reporter.filename == "test.game"
    ...
    def test_report_error(self):
        ...
        location = SourceLocation("test.game", 1, 1, 1)
    ...
    def test_multiple_errors(self):
        ...
        for i in range(3):
            location = SourceLocation("test.game", i + 1, 1, 1)
    ...
    def test_get_all_messages(self):
        ...
        reporter.report_error(ErrorType.SYNTAX, "error 3", SourceLocation("test.game", 3, 1, 1))
        reporter.report_error(ErrorType.SYNTAX, "error 1", SourceLocation("test.game", 1, 1, 1))
        reporter.report_warning(ErrorType.SEMANTIC, "warning 2", SourceLocation("test.game", 2, 1, 1))
...
class TestErrorFormatting:
    ...
    def test_format_error_basic(self):
        ...
        reporter = ErrorReporter()
        location = SourceLocation("test.game", 5, 10, 1)
        ...
        assert "test.game:5:10" in formatted
    ...
    def test_format_error_with_caret(self):
        ...
        location = SourceLocation("test.game", 2, 5, 1)
    ...
    def test_format_error_multi_character(self):
        ...
        location = SourceLocation("test.game", 1, 6, 7)
    ...
    def test_format_warnings(self):
        ...
        location = SourceLocation("test.game", 2, 5, 10)
        ...
        assert "test.game:2:5" in formatted
    ...
    def test_format_all_with_summary(self):
        ...
        reporter.report_error(ErrorType.SYNTAX, "error 1", SourceLocation("test.game", 1, 1, 1))
        reporter.report_error(ErrorType.SYNTAX, "error 2", SourceLocation("test.game", 2, 1, 1))
        reporter.report_warning(ErrorType.SEMANTIC, "warning 1", SourceLocation("test.game", 1, 5, 1))
    ...
    def test_format_all_errors_only(self):
        ...
        reporter.report_error(ErrorType.SYNTAX, "error", SourceLocation("test.game", 1, 1, 1))
    ...
    def test_format_all_warnings_only(self):
        ...
        reporter.report_warning(ErrorType.SEMANTIC, "warning", SourceLocation("test.game", 1, 1, 1))
