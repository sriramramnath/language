...
def game_over_screen(score):
    ...
    draw_text(screen, f"Final Score: {score}", 40, WIDTH // 2, HEIGHT // 2)
    draw_text(screen, "Press SPACE to Play Again", 30, WIDTH // 2, HEIGHT * 3 // 4)
    draw_text(screen, "Press ESC to Quit", 30, WIDTH // 2, HEIGHT * 3 // 4 + 40)
    pygame.display.flip()
...
def main():
    ...
    while running:
        ...
        while game_active:
            ...
            # Draw score
            draw_text(screen, f"Score: {player.score}", 36, 80, 10)
            draw_text(screen, "Arrow Keys to Move", 24, WIDTH - 100, 10)
